...
class AppConfig(BaseSettings):
    ...
    mongodb_test_database: str = Field(
        default="backend_fastapi_app_test", description="MongoDB test database name"
    )
    ...
    postgres_test_db: str = Field(
        default="database_test", description="PostgreSQL test database name"
    )
    ...
    @property
    def postgre_test_database_url(self) -> str:
        """Construct PostgreSQL test database URL from components."""
