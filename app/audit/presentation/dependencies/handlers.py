...
from app.audit.application.handlers import (
    CreateLogHandler,
    GetLogByIdHandler,
...
ListLogsByActionHandlerDep = Annotated[
    ListLogsByActionHandler, Depends(get_list_logs_by_action_handler)
]
ListLogsByDateRangeHandlerDep = Annotated[
    ListLogsByDateRangeHandler, Depends(get_list_logs_by_date_range_handler)
]
